...
> Todo el contenido está explicado paso a paso en el archivo [`[PDF] Practica 1`](./docs/[PDF]_Practica_1.pdf.pdf) que se encuentra en la carpeta docs, incluyendo fragmentos de código comentados y la evolución progresiva de cada clase.
